...
> 状态：2026-08-01 的历史设计快照，包含已删除的标签、旧缩略图存储和旧状态语义，不再是运维或实现真源。
> 当前行为见 [README](../README.md)，审查后的目标架构见 [2026-08-15 报告](./2026-08-15_security-architecture-product-report.md)。
